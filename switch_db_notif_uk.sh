...
nfsinkpathfr=\$(grep "^sink.spool.path = /opt/HUB/NOTIF/updatemtnotif_fr\$" $notifl2filterconf | wc -l) 2>&1
restartnf=0
...
nfsinkpathuk=\$(grep "^sink.spool.path = /opt/HUB/NOTIF/updatemtnotif\$" $notifl2filterconf | wc -l) 2>&1
restartnf=0
