...
mtdbfr=\$(grep "fr1a2pasedbvcs:5000/a2p_msgdb_fr1" $mtconf | wc -l)
mtcurdb=\$(grep "sybase:Tds:uk4a2pasedbvcs" $mtlog | tail -n1 | wc -l)
restartmt=0
...
sockmvfr=\$(grep "updatemtnotif_fr/inputspool" $notifl1sockconf | wc -l)
restartsockmv=0
...
mtdbuk=\$(grep "uk4a2pasedbvcs:5000/a2p_msgdb_uk4" $mtconf | wc -l)
mtcurdb=\$(grep "sybase:Tds:fr1a2pasedbvcs" $mtlog | tail -n1 | wc -l)
restartmt=0
...
sockmvuk=\$(grep "updatemtnotif/inputspool" $notifl1sockconf | wc -l)
restartsockmv=0
